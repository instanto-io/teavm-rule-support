...
public class VoidInvokeDiagnosticTeaVmTest {
   ...
   *
   * <p>Only {@link VoidInvokeDiagnosticTeaVmTest#probeVoidMethod()} is invoked, so the extra call
   * re-enters an empty body. Probing whichever test happened to be running would re-enter that
      ...
      return new Statement() {
        ...
        public void evaluate() throws Throwable {
          if (PROBE.equals(method.getName())) {
            assertNull(
                "rule support must normalise TeaVM's undefined to null",
  ...
  public void rawReflectionStillReturnsUndefinedOnThisTeaVm() throws Exception {
    Method method = VoidInvokeDiagnosticTeaVmTest.class.getDeclaredMethod("probeVoidMethod");
    ...
    assertFalse(
        "TeaVM now returns null for void invoke - normalisation can be removed", result == null);
  }
