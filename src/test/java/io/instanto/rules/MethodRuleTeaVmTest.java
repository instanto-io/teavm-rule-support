...
public class MethodRuleTeaVmTest {
    ...
    @Rule
    public RecordingMethodRule methodRule = new RecordingMethodRule("method");

    @Rule
    public RecordingTestRule testRule = new RecordingTestRule("test");
    ...
    public void methodRuleReceivesTheTestMethodAndRunsInsideTheTestRule() {
        ...
        assertEquals("enter:method:methodRuleReceivesTheTestMethodAndRunsInsideTheTestRule",
